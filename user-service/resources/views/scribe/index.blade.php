...
<head>
    ...
    <title>UserService API Documentation</title>
    ...
    <script>
        var tryItOutBaseUrl = "https://user-service.lc";
        var useCsrf = Boolean();
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-users--user_id-">GET api/users/{user_id}</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PATCHapi-users--user_id-">
                                <a href="#endpoints-PATCHapi-users--user_id-">PATCH api/users/{user_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-users--user_id-">
                                <a href="#endpoints-DELETEapi-users--user_id-">DELETE api/users/{user_id}</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<aside>
    <strong>Base URL</strong>: <code>https://user-service.lc</code>
</aside>
...
<div class="bash-example">
    ...
    "https://user-service.lc/api/login" \
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "https://user-service.lc/api/users" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"name\": \"b\",
...
<div class="bash-example">
    ...
    --get "https://user-service.lc/api/me" \
    --header "Content-Type: application/json" \
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "https://user-service.lc/api/logout" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://user-service.lc/api/users/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://user-service.lc/api/users/1"
);
...
<p>The ID of the user. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-PATCHapi-users--user_id-">PATCH api/users/{user_id}</h2>
...
<p>Must be at least 8 characters. Example: <code>-0pBNvYgxw</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-users--user_id-">DELETE api/users/{user_id}</h2>
