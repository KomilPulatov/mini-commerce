...
<head>
    ...
    <title>PaymentService API Documentation</title>
    ...
    <script>
        var tryItOutBaseUrl = "https://payment-service.lc";
        var useCsrf = Boolean();
...
<aside>
    <strong>Base URL</strong>: <code>https://payment-service.lc</code>
</aside>
...
<div class="bash-example">
    ...
    "https://payment-service.lc/api/payments" \
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               step="any"               name="order_id"                data-endpoint="POSTapi-payments"
               value="16"
               data-component="body">
    <br>
